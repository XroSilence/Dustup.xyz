...
function MainPage() {
  return (
    <div>
      ...
      import {Link} from 'react-router-dom'
      const App = () ={'>'} {
        set[activeIntent, setActiveIntent] = useState(null);
        ...
        <div className="max-w-4xl mx-auto mb-12 text-center relative">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              <Wind
                className={`w-10 h-10 text-white transition-transform duration-500 ${isHovered ? 'rotate-180' : ''
                  }`}
              />
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-4">
                    <path.icon className={`w-7 h-7 ${activeIntent === path.id ? 'text-white' : 'text-slate-300'
                      }`} />
                ...
                <p className={`text-lg ${activeIntent === path.id ? 'text-white' : 'text-slate-300'
                  }`}>
                  {path.description}
                </p>
              </div>
